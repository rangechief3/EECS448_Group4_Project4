...
#from . player import Player (commented out to test player.py)
...
class Data:
    ...
    def get_player_bets(self, bet_round):
        ...
        if bet_round >= 0 and bet_round <= 3:
            ...
            if bet_round == 0:
                ...
                self.add_to_pot(self.dealer + 1, blind, SM_BLIND,
                                bet_round)  # value may not be equal to blind if player has less
    ...
    def add_to_pot(self, player_num, amt, curr_bet, bet_round):
        ...
        if len(self.pots) == 0:
            ...
            pot_list = [amt, bet_round, curr_bet, player_num,
                        amt]  # [total, betting round, current bet, player1 ... playerk]
    ...
    def check_duplicates(self,
                         player_num):  # will determine pairs, two pairs, three of a kind, four of a kind, full house
        player_cards = self.table_cards + self.player_hands[player_num]
